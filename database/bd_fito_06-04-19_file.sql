...
CREATE TABLE IF NOT EXISTS `bd_fito`.`colaboradores_has_campanhas` (
  ...
  `id` INT NOT NULL,
  `objetivo_acumulado` INT NULL COMMENT 'Campo para cadastrar o número de itens ou valor durante toda a campanha, é utilizado para verificar se a meta foi cumprida ou não.',
